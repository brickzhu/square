# Chinese checkers star board (121 cells). 2-player: opposite star tips (对顶),
# 15 marbles each, win by filling opponent's home. 6-player: ten marbles per seat
# on six tip clusters; goal is opposite tip (+3 mod 6).
#
# 注意：下面 _START/_END 是拼成 121 孔的静态分区命名，**不是**「双人局座位1/2」的别名。
# 双人开局/目标营由 checkers_two_player_homes() 按对顶两尖从全集切出（与 _START1 及顶角 15 孔一致）。
...
# 西北臂一簇（六人局座位2 尖 (-8,4) 附近），勿与双人「座位2 营」（顶角 (-4,8)）混淆
